...
export default function Header() {
  ...
  return (
    <>
        ...
        <Modal.Body>
          ...
          <div class="flex-row" style={{ display: "flex", marginLeft: "1rem" }}>
            ...
            <div class="phone-number-container" style={{ border: "none" }}>
              ...
              <div class="mb-1 phone-number">
                <a href="tel:+6281234462840" class="phone-number">
                  {" "}
                  0812 3446 2840
                </a>
              </div>{" "}
      ...
      <div onClick={(e) => openModal(e)} class="mobile contact">
        <div style={{marginLeft: "1rem"}}>
          <a href="">
            <img src={phone} style={{ height: "3rem" }}></img>
          </a>
        </div>
      ...
      <div
        class="mobile navbar-mobile menu-mobile sticky-top navbar-menu sticky-navbar"
      ...
      <div class="sticky-top">
        <div class="navbar navbar-pc navbar-menu navbar-light bg-light hidden w-full border-t border-gray-300 shadow-sm lg:justify-center lg:items-center sticky-navbar">
